...
inherit cmake cmake-native clang14 pkgconfig python3native
...
DEPENDS:append:class-target = " clang14-cross-${TARGET_ARCH} virtual/${MLPREFIX}libc gcc-runtime"
DEPENDS:append:class-nativesdk = " clang14-native clang14-crosssdk-${SDK_ARCH} nativesdk-gcc-runtime"
...
COMPILER_RT:class-nativesdk:toolchain-clang14:runtime-llvm = "-rtlib=libgcc --unwindlib=libgcc"
LIBCPLUSPLUS:class-nativesdk:toolchain-clang14:runtime-llvm = "-stdlib=libstdc++"
...
BUILD_CC:toolchain-clang14  = "${CCACHE}clang"
BUILD_CXX:toolchain-clang14 = "${CCACHE}clang++"
BUILD_CPP:toolchain-clang14 = "${CCACHE}clang -E"
BUILD_CCLD:toolchain-clang14 = "${CCACHE}clang"
BUILD_RANLIB:toolchain-clang14 = "llvm-ranlib"
BUILD_AR:toolchain-clang14 = "llvm-ar"
BUILD_NM:toolchain-clang14 = "llvm-nm"
