...
inherit cmake cmake-native clang17 python3native
...
DEPENDS:append:class-target = " clang17-cross-${TARGET_ARCH} virtual/${MLPREFIX}libc virtual/${TARGET_PREFIX}compilerlibs"
