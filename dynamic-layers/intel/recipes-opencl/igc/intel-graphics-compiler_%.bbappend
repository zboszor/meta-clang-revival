...
SRC_URI:prepend = "git://github.com/intel/intel-graphics-compiler.git;protocol=https;name=igc;branch=releases/igc-1.0.17791 "
SRC_URI:append = " file://0001-Fix-using-BiFManager-bin-when-cross-compiling.patch"
